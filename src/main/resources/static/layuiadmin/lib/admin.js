...
;layui.define("view", function (e) {
    var a = layui.jquery, i = layui.laytpl, t = layui.element, n = layui.setter, l = layui.view, s = layui.device(),
        ...
        x = "layui-icon-spread-left", C = "layadmin-side-shrink", k = "LAY-system-side-menu", P = {
            ...
            flexible: function (e) {
                ...
                var webTemplateChoice=$("#webTemplateChoice").val();
                P.popupRight({
                    id: "LAY_adminPopupAbout", success: function () {
                        if(webTemplateChoice==4){
                            l(this.id).render("system/about3")
                        }else if(webTemplateChoice==3){
                            l(this.id).render("system/about2")
                        }else if(webTemplateChoice==2){
                            l(this.id).render("system/about1")
                        }else {
    ...
    o.on("click", z, function () {
        ...
        layui.router();
        var hrefurl = i;
        // $("li[lay-id='"+hrefurl+"']").find('i').click();
        P.tabsPage.elem = e;
